...
import static com.github.qbek.screenplay.data.account.AccountAbilityFactory.useActiveAccountWithBasicAuth;
import static com.github.qbek.screenplay.data.account.AccountAbilityFactory.useActiveAccountWithTokenAuth;
...
public class FactsFactory {
    ...
    public static Fact creditCardWithActiveAccount() {
        return new CardAndAccount(
                ...
                (UseAccount) useActiveAccountWithBasicAuth()
        );
    }
    ...
    public static Fact activeAccount() {
        return new CardAndAccount((UseAccount) useActiveAccountWithBasicAuth());
    }

    public static Fact activeAccountWithAuthTokenAuthorization() {
        boolean useAuthToken = true;
        return new CardAndAccount((UseAccount) useActiveAccountWithTokenAuth());
    }
}
